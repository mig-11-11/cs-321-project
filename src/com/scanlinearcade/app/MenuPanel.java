...
public class MenuPanel extends JPanel
{
    ...
    private void loadBackgroundImage()
    {
        try
        {
            URL resourceUrl = getClass().getResource(IMAGE_PATH);
            if (resourceUrl == null)
            {
                resourceUrl = Thread.currentThread()
                    .getContextClassLoader()
                    .getResource("com/scanlinearcade/assets/arcade_menu_bg.png");
            }
            ...
            File sourceAsset = new File("src/com/scanlinearcade/assets/arcade_menu_bg.png");
            if (sourceAsset.exists())
            {
                backgroundImage = ImageIO.read(sourceAsset);
                return;
            }

            throw new IOException("arcade_menu_bg.png not found in classpath or source tree");
        }
